...
# Constraints for Count[6:0], UP, and reset ports

# Count[6:0] pins (example pin assignment, adjust if needed)
set_property -dict { PACKAGE_PIN T11   IOSTANDARD LVCMOS33 } [get_ports { Count[0] }];
set_property -dict { PACKAGE_PIN T10   IOSTANDARD LVCMOS33 } [get_ports { Count[1] }];
set_property -dict { PACKAGE_PIN R10   IOSTANDARD LVCMOS33 } [get_ports { Count[2] }];
set_property -dict { PACKAGE_PIN R11   IOSTANDARD LVCMOS33 } [get_ports { Count[3] }];
set_property -dict { PACKAGE_PIN P11   IOSTANDARD LVCMOS33 } [get_ports { Count[4] }];
set_property -dict { PACKAGE_PIN P10   IOSTANDARD LVCMOS33 } [get_ports { Count[5] }];
set_property -dict { PACKAGE_PIN N10   IOSTANDARD LVCMOS33 } [get_ports { Count[6] }];

# UP signal pin (example pin assignment, adjust if needed)
set_property -dict { PACKAGE_PIN M10   IOSTANDARD LVCMOS33 } [get_ports { UP }];

# Reset signal pin (example pin assignment, adjust if needed)
set_property -dict { PACKAGE_PIN L10   IOSTANDARD LVCMOS33 } [get_ports { reset }];
