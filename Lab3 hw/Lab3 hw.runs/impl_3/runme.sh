...
HD_PWD='C:/Users/aniru/Desktop/ELD/Lab3 hw/Lab3 hw.runs/impl_3'
cd "$HD_PWD"
...
EAStep vivado -log Top_Count.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Top_Count.tcl -notrace
