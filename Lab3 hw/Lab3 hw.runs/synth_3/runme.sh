...
HD_PWD='C:/Users/aniru/Desktop/ELD/Lab3 hw/Lab3 hw.runs/synth_3'
cd "$HD_PWD"
...
EAStep vivado -log Top_Count.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Top_Count.tcl
