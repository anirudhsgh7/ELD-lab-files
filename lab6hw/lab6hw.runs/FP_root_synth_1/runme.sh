...
HD_PWD='C:/Users/aniru/Desktop/ELD/lab6hw/lab6hw.runs/FP_root_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FP_root.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FP_root.tcl
