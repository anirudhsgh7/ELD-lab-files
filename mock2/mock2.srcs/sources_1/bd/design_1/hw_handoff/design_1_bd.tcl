...
connect_bd_intf_net -intf_net [get_bd_intf_nets floating_point_0_M_AXIS_RESULT] [get_bd_intf_pins floating_point_0/M_AXIS_RESULT] [get_bd_intf_pins system_ila_0/SLOT_1_AXIS]
  ...
  connect_bd_intf_net -intf_net floating_point_1_M_AXIS_RESULT [get_bd_intf_pins floating_point_0/S_AXIS_B] [get_bd_intf_pins floating_point_1/M_AXIS_RESULT]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets xfft_0_M_AXIS_DATA] [get_bd_intf_pins system_ila_0/SLOT_0_AXIS] [get_bd_intf_pins xfft_0/M_AXIS_DATA]
  ...
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axis_dwidth_converter_0/aresetn] [get_bd_pins floating_point_0/aresetn] [get_bd_pins floating_point_1/aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn] [get_bd_pins system_ila_0/resetn] [get_bd_pins xfft_0/aresetn]
  ...
  connect_bd_net -net xlconstant_2_dout [get_bd_pins floating_point_1/s_axis_a_tdata] [get_bd_pins xlconstant_2/dout]
  connect_bd_net -net xlconstant_3_dout [get_bd_pins floating_point_1/s_axis_a_tvalid] [get_bd_pins xlconstant_3/dout]
